...
namespace Memberships.Areas.Admin.Controllers
{
    public class ItemController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Title,Description,Url,ImageUrl,HTML,WaitDays,ProductId,TypeId,SectionId,PartId,IsFree")] Item item)
        {
        ...
        public async Task<ActionResult> Edit(int? id)
        {
            ...
            // en mode asynchrone pour liberer le processus à faire autre chose en attendant les résultats des lectures
